...
#______________________________________________________________________________________________
                ...
                # {
                #   "count": store_count int number of people, negative for people leaving, positve for people entering
                #   "ppechack": ppecheck bool, True== persone has a mask, False== could not detect mask
